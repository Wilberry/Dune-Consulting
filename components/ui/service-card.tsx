...
export function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <article className="group border-line hover:border-amber hover:shadow-navy/8 flex min-h-72 flex-col rounded-xl border bg-white p-7 transition hover:-translate-y-1 hover:shadow-xl">
