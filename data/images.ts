...
export const siteImages: SiteImage[] = [
  ...
  approvedImage(
    "/images/conference_event.webp",
    "Conference and event safety management operations",
    "Event Safety Management",
    "1600×1200px",
    "4:3",
  ),
  approvedImage(
    "/images/contact_office.webp",
    "Contact office environment where Dune Consulting receives client enquiries",
    "Contact",
    "1600×1200px",
    "4:3",
  ),
